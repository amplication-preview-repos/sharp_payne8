  ...
  test("POST /emails", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        receivedDateTime: CREATE_RESULT.receivedDateTime.toISOString(),
      ...
      .expect([
        {
          ...
          receivedDateTime: FIND_MANY_RESULT[0].receivedDateTime.toISOString(),
  ...
  test("GET /emails/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        receivedDateTime: FIND_ONE_RESULT.receivedDateTime.toISOString(),
